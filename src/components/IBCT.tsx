...
const pillars = [
  {
    icon: Heart,
    title: "Emotionele acceptatie",
    text: "Via empathische aansluiting en gezamenlijke onthechting: begrijpen hoe jullie patronen ontstaan en wat ze bij de ander losmaken, om ruimte te maken voor echte verbinding.",
    delay: "100",
  },
  {
    icon: HandHeart,
