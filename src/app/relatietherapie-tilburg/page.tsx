    ...
    <>
      ...
      <main className="bg-[#F5F0EB]">
        ...
        <section id="inhoud" className="section-padding bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-[#5E524F] text-base md:text-lg leading-relaxed space-y-5">
              ...
              <p>
                Als IBCT-relatietherapeut in Tilburg kom ik bij jullie thuis, zodat jullie in een
                vertrouwde omgeving kunnen werken aan verbinding en helderheid.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section-padding bg-[#F5F0EB]">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-[family-name:var(--font-playfair)] font-bold text-[#6B6866] mb-6 text-center">
              IBCT-relatietherapie aan huis in Tilburg
            </h2>
            <div className="text-[#5E524F] text-base md:text-lg leading-relaxed space-y-5">
              <p>
                Als relatietherapeut in Tilburg werk ik met IBCT (Integrative Behavioral Couple
                Therapy), een evidence-based methode die bestaat uit vier onderdelen die elkaar
                versterken: acceptatie, tolerantie, gedragsverandering en communicatie. IBCT
                combineert twee sporen: onderlinge verschillen accepteren en gedrag veranderen
                waar dat wél kan. Deze aanpak past goed bij koppels die zoeken naar
                relatietherapie, huwelijkstherapie of koppeltherapie in Tilburg en omgeving, en
                biedt zowel verdieping als praktische handvatten om patronen te doorbreken.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section-padding bg-[#F5F0EB]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-2xl p-8 md:p-10 text-[#5E524F] leading-relaxed space-y-5">
              <p>
                IBCT combineert acceptatie en verandering. We onderzoeken eerst jullie patronen
                ...
                oproepen. Vanuit die basis bouwen we aan positief gedrag en kleine, haalbare
                veranderingen die direct effect hebben in het dagelijks leven. Tot slot
                versterken we jullie communicatie, zodat gesprekken minder snel escaleren en
                jullie elkaar beter kunnen bereiken.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section-padding bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-[family-name:var(--font-playfair)] font-bold text-[#6B6866] mb-4">
                Praktisch: relatietherapie aan huis in Tilburg
              </h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  icon: MapPin,
                  title: "Werkgebied",
                  text: "Heel Tilburg, inclusief Reeshof, Centrum, Oud-Noord, de Hasselt, Berkel-Enschot, en omliggende plaatsen zoals Dongen, Goirle, Udenhout en Loon op Zand.",
                },
                {
                  icon: Clock,
                  title: "Sessieduur",
                  text: "Vanaf 1 oktober 2026 duurt een sessie 75 minuten, zo is er genoeg ruimte om echt de diepte in te kunnen gaan.",
                },
                {
                  icon: Heart,
